...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'twyauth_twitterprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('twitter_userid', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('since_id', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
        ))
        db.send_create_signal(u'twyauth', ['TwitterProfile'])

        # Adding model 'RugbyTweet'
        db.create_table(u'twyauth_rugbytweet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('tweetid', self.gf('django.db.models.fields.BigIntegerField')()),
            ('created_at', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('matches', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('confidence', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=4)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twyauth.TwitterProfile'], null=True)),
        ))
        db.send_create_signal(u'twyauth', ['RugbyTweet'])


    def backwards(self, orm):
        # Deleting model 'TwitterProfile'
        db.delete_table(u'twyauth_twitterprofile')

        # Deleting model 'RugbyTweet'
        db.delete_table(u'twyauth_rugbytweet')
