...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'trivia_userpoints', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('points', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'trivia', ['UserPoints'])

        # Adding field 'QuestionLevel.points'
        db.add_column(u'trivia_questionlevel', 'points',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'trivia_userpoints')

        # Deleting field 'QuestionLevel.points'
        db.delete_column(u'trivia_questionlevel', 'points')
